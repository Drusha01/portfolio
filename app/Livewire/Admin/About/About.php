...
class About extends Component
{
    ...
    public function update_data(){
        ...
        foreach ($skill_filter as $key => $value) {
            array_push($this->skill_columns,$value->column_name);
        ...
        $this->skill_data =self::paginate( $this->skill_params['table'],  $this->skill_columns,$this->skill_params['paginate_by'],
            $this->skill_params['inbetween'],$this->skill_params['offset'], $this->skill_params['cursor'] , $this->skill_params['page']  );
    }
    ...
    public function update_skill_params($inbetween = 3,$offset=20,$current_cursor,$page){
        $this->skill_params['inbetween'] = $inbetween;
        $this->skill_params['offset'] = $this->skill_params['offset'];
        $this->skill_params['cursor'] = $current_cursor;
        $this->skill_params['page'] = $page;
