                ...
                <div class="col-lg-10 @if($mode == 1) bg-light @else bg-dark @endif shadow justify-content-center p-3 mb-5 rounded-4">
                    <form action="send_email()" class="">
                        <div class="row pt-5">
                            ...
                            <div class="col-sm-6 mb-3">
                                <input type="text" class="form-control" wire:model.defer="email.email" placeholder="Your email" required>
                            </div>
                            <div class="col-lg-12 mb-3">
                                <input type="text" class="form-control" wire:model.defer="email.subject" placeholder="Subject" required>
                            </div>
                            <div class="col-lg-12 mb-3">
