                ...
                <nav class="navbar navbar-expand-lg " >
                    <div class="collapse d-none d-lg-block text-uppercase" id="collapseExample">
                        <ul class="navbar-nav px-2 ">
                            <li class="nav-item"  @click.debounce.500ms="scrollTo({top: 0, behavior: 'smooth'})"><a href="@if($user_id && $user_id!=1)  /homepage/{{$user_id}} @else {{ Route('homepage.drusha') }} @endif" wire:navigate class="nav-link @if($mode == 0) text-white @else text-dark @endif active"><strong>HOME</strong></a></li>
                            <li class="nav-item"  @click.debounce.500ms="scrollTo({top: 0, behavior: 'smooth'})"><a href="@if($user_id && $user_id!=1)  /about/{{$user_id}} @else {{ Route('about.drusha') }} @endif " wire:navigate class="nav-link @if($mode == 0) text-white @else text-dark @endif"><strong>About</strong></a></li>
                            <li class="nav-item"  @click.debounce.500ms="scrollTo({top: 0, behavior: 'smooth'})"><a href="@if($user_id && $user_id!=1)  /faq/{{$user_id}} @else {{ Route('faq.drusha') }} @endif " wire:navigate class="nav-link @if($mode == 0) text-white @else text-dark @endif"><strong>FAQs</strong></a></li>
                            ...
                            <li class="nav-item"  @click.debounce.500ms="scrollTo({top: 0, behavior: 'smooth'})"><a href="@if($user_id && $user_id!=1)  /projects/{{$user_id}} @else {{ Route('project.drusha') }} @endif " wire:navigate class="nav-link @if($mode == 0) text-white @else text-dark @endif"><strong>Projects</strong></a></li>
                            <li class="nav-item"  @click.debounce.500ms="scrollTo({top: 0, behavior: 'smooth'})"><a href="@if($user_id && $user_id!=1)  /blogs/{{$user_id}} @else {{ Route('blog.drusha') }} @endif" wire:navigate class="nav-link @if($mode == 0) text-white @else text-dark @endif"><strong>Blogs</strong></a></li>
                            <li class="nav-item"  @click.debounce.500ms="scrollTo({top: 0, behavior: 'smooth'})"><a href="@if($user_id && $user_id!=1)  /contact/{{$user_id}} @else {{ Route('contact.drusha') }} @endif" wire:navigate.hover class="nav-link @if($mode == 0) text-white @else text-dark @endif"><strong>Contact</strong></a></li>
                ...
                <div class="offcanvas offcanvas-end @if($mode == 1) text-dark @else text-white  bg-secondary @endif" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
                    ...
                    <div class="offcanvas-body">
                        ...
                        <li class="nav-item"><a href="{{ Route('home.drusha') }}" wire:navigate class="nav-link @if($mode == 0) text-white @else text-dark @endif active"><strong><i class="bi bi-house-door"></i> HOME</strong></a></li>
                            ...
                            <li class="nav-item"><a href="{{ Route('blog.drusha') }}" wire:navigate class="nav-link @if($mode == 0) text-white @else text-dark @endif"><strong><i class="bi bi-file-earmark-richtext"></i> Blogs</strong></a></li> 
                            ...
                            <li class="nav-item"><a href="/cv/Dumapit-Hanrickson-E.pdf" target="_blank" class="nav-link @if($mode == 0) text-white @else text-dark @endif"><i class="bi bi-folder"></i> <strong>Download CV </strong></a></li>
