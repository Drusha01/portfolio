                ...
                <nav class="navbar navbar-expand-lg " >
                    <div class="collapse d-none d-lg-block text-uppercase" id="collapseExample">
                        <ul class="navbar-nav px-2 ">
                            ...
                            <li class="nav-item"  @click.debounce.500ms="scrollTo({top: 0, behavior: 'smooth'})"><a href="@if($user_id && $user_id!=1)  /blogs/{{$user_id}} @else {{ Route('blog.drusha') }} @endif" wire:navigate class="nav-link @if($mode == 0) text-white @else text-dark @endif"><strong>Blog</strong></a></li>
