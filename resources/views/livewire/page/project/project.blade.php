                        ...
                        <div class="row">
                            <div class="col-12 p-0">
                                <div style="--swiper-navigation-color: #fff; --swiper-pagination-color: #fff" class="swiper mySwiper-{{$key}}-1 ">
                                    <div class="swiper-wrapper mb-2" style="width:inherit;max-height:600px">
                                            @foreach($value['project_image_contents'] as $pic_key =>$pic_value)
                                                <div class="swiper-slide">
                                                    <img src="{{asset('storage/content/project_image_contents/'.$pic_value['image'])}}" style="object-fit:cover;width:inherit;max-height:600px"/>
                                                </div>
                                            @endforeach
                                    </div>
